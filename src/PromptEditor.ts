...
export class PromptEditor {
    public static currentPanel: PromptEditor | undefined;
    ...
    public static render(extensionUri: Uri) {
        if (PromptEditor.currentPanel) {
            // If the webview panel already exists reveal it
            PromptEditor.currentPanel._panel.reveal(ViewColumn.One);
        } else {
            ...
            PromptEditor.currentPanel = new PromptEditor(panel, extensionUri);
        }
    }
     ...
     */
    public dispose() {
        PromptEditor.currentPanel = undefined;
